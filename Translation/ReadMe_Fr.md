...
## Micro Club participe au Hacktoberfest!
Un référentiel pour les membres du Micro Club dédié à la 6ème édition du Hacktoberfest (2k19). Le but de ce repo est de faire entrer les membres MC et tous autres débutants dans la communauté open source et de les aider à développer et à partager des projets et des connaissances avec d'autres étudiants, professionnels et passionnés de l'open source, tout en ayant un défi amusant !!

## Qu'est-ce que le Hacktoberfest? 
#### "Changer la communauté open source,un'pull request'à la fois."- Digital Ocean.
Le Hacktoberfest est une celebration qui dure un mois du**Octobre du 1er au 31** sponsorisée par [Digital Ocean](https://www.digitalocean.com/) et [GitHub](https://github.com/blog/2433-celebrate-open-source-this-october-with-hacktoberfest) pour initier les gens dans l'[Open Source](https://github.com/open-source).Cette année tous les experts et les niveaux avencée de la communauté open source ['DEV'](https://dev.to/) ont rejoint la fête en tant que partenaire de l'événement! 
Les premières ** 50 000 ** personnes du monde à accomplir  4  pull request à n’importe quel repo public recevront un ** T-SHIRT GRATUIT EDITON LIMITE TOTALMENT SWAGS! **

### Pour plus d’info sur l’événement: [Hacktoberfest event website](https://hacktoberfest.digitalocean.com/)

> - **Le Hacktoberfest est ouvert à toute la communauté globale!**
> - **Les Pull requests peuvent t’être crée dans n’importe quel  GitHub-hosted répertoire/projets. **
